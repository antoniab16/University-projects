    ...
    while(1){
        ...
        if(option_admin == "0")
            ...
            try {
                ...
                cin.ignore();
                getline(cin, trailer);
                controller.addMovie(title, genre, year_release, likes, trailer);
            ...
            try {
                ...
                cin >> year_release;
                controller.removeMovie(title, year_release);
            } catch (const std::runtime_error& e){
                cout<<"Error : "<<e.what()<<endl;
            }
        }
            ...
            try {
                ...
                cin.ignore();
                getline(cin, trailer);
                this->controller.updateMovie(title, year, genre, likes, trailer);
            } catch(const std::runtime_error& e){
                cout<<"Error : "<<e.what()<<endl;
            }
        }
...
void UI::printWatchlist() {
    Watchlist watchlist = controller.getWatchlist();
